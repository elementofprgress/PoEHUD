...
namespace PoeHUD.Hud.Menu
{
    public class MenuPlugin : Plugin<MenuSettings>
    {
        ...
        private void CreateMenu()
        {
            ...
            MenuItem  alternative             = AddChild(itemAlertMenu, itemAlertStaticMenuList[0], settingsHub.ItemAlertSettings.Alternative, null,
                    y => itemAlertStaticMenuList.All(x => x != (y as ToggleButton)?.Name));
            ...
            AddChild(iconSizeMenu,                         "Use border color for loot icon",
                    settingsHub.ItemAlertSettings.LootIconBorderColor); // Adding a ToggleNode as a RangeNode child doesn't display it
